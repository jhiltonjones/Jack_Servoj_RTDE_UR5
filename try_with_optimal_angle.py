...
from min_jerk_test3 import PathPlanTranslation  # Ensure this module is available
...
trajectory_time_total = 20 # Total time for full motion
...
while current_waypoint_index < len(waypoints) - 1:
    ...
    planner = PathPlanTranslation(start_point, end_point, trajectory_time_per_segment, arc_height=0.05)  # Adjust arc height
...
print("Rotation angle in radians added: ", 40)
rotation_angle_radians = np.deg2rad(40)  # Example: adding 100 degrees
